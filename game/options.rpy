...
define config.name = _("The Only Easy Day Was Yesterday")
...
define build.name = "TheOnlyEasyDayWasYesterday"
...
define config.save_directory = "TheOnlyEasyDayWasYesterday-1600351708"
